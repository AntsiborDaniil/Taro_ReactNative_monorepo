...
export const spreadInnerStyles = StyleSheet.create({
  ...
  altarZone: {
    ...
    backgroundColor: 'rgba(14, 18, 28, 0.72)',
    overflow: 'visible',
    position: 'relative',
    marginHorizontal: 16,
    ...Platform.select({
      web: {
        boxShadow:
          'inset 0 0 60px rgba(246, 192, 27, 0.05), 0 16px 40px rgba(8, 12, 20, 0.35)',
      },
      default: {},
    }),
  },
  altarGlow: {
    ...
    left: '-20%',
    borderRadius: 999,
    backgroundColor: getColorOpacity(COLORS.Primary500, 8),
    pointerEvents: 'none',
  },
  altarHint: {
    marginTop: 10,
