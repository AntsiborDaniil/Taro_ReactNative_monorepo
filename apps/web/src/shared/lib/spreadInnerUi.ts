...
export const spreadInnerStyles = StyleSheet.create({
  ...
  altarZone: {
    ...
    backgroundColor: getColorOpacity(COLORS.SpbSky4, 55),
    // Visible so flying card / flip aren't clipped on desktop web
    overflow: 'visible',
    position: 'relative',
    marginHorizontal: 16,
  },
  altarGlow: {
    ...
    left: '-20%',
    borderRadius: 999,
    backgroundColor: getColorOpacity(COLORS.Primary, 6),
    pointerEvents: 'none',
  },
  altarHint: {
    marginTop: 8,
